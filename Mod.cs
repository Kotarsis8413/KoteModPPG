        ...
        AfterSpawn = (Instance) =>
        {
            ...
            ModAPI.Register(
                new Modification()
                {
                    OriginalItem = ModAPI.FindSpawnable("9mm Pistol"),
                    NameOverride = "USP-S",
                    DescriptionOverride = "200$ for CT",
                    CategoryOverride = ModAPI.FindCategory("KoteM"),
                    ThumbnailOverride = ModAPI.LoadSprite("USP.png"),
                    AfterSpawn = (Instance) =>
                    {
                        ModAPI.KeepExtraObjects();
                        ...
                        Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("USP.png");

                        var Slide = Instance.transform.Find("Slide");
                        Slide.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("USPslide.png");

                        var firearm = Instance.GetComponent<FirearmBehaviour>();

                        Cartridge customCartridge = ModAPI.FindCartridge("9mm");
                        customCartridge.name = "9x4mm Usp";
                        customCartridge.Damage *= 5.1f;
                        customCartridge.StartSpeed *= 50f;
            ...
            ModAPI.Register(
                ...
                {
                    OriginalItem = ModAPI.FindSpawnable("9mm Pistol"),
                    NameOverride = "Mega Pistol",
                    DescriptionOverride = "...",
                    CategoryOverride = ModAPI.FindCategory("KoteM"),
                    ThumbnailOverride = ModAPI.LoadSprite("megapistol/megap.png"),
                    AfterSpawn = (Instance) =>
                    {
                        ModAPI.KeepExtraObjects();
                        ...
                        Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("megapistol/megap.png");

                        var Slide = Instance.transform.Find("Slide");
                        Slide.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("megapistol/megapslide.png");

                        var firearm = Instance.GetComponent<FirearmBehaviour>();

                        Cartridge customCartridge = ModAPI.FindCartridge("9mm");
                        customCartridge.name = "2x5mm MegaP";
                        customCartridge.Damage *= 2000.1f;
                        customCartridge.StartSpeed *= 500.2f;
                        customCartridge.Recoil *= 1.5f;
                        customCartridge.PenetrationRandomAngleMultiplier *= 0.25f;
                        customCartridge.ImpactForce *= 0.8f;
                        ...
                        firearm.ShotSounds = new AudioClip[]
                        {
                ModAPI.LoadSound("megapistol/megap1.mp3"),
                ModAPI.LoadSound("megapistol/megap1.mp3"),
                ModAPI.LoadSound("megapistol/megap1.mp3")
                        };
                    }
            ...
            ModAPI.Register(
                new Modification()
                {
                    ...
                    NameOverride = "TTuTTcNk2",
                    NameToOrderByOverride = "Android1",
                    DescriptionOverride = "NDN cyda moi cladenkiy)",
                    CategoryOverride = ModAPI.FindCategory("KoteM"),
                    ThumbnailOverride = ModAPI.LoadSprite("my/Pupsik2Ava.PNG"),
                    AfterSpawn = (Instance) =>
                    {
                        var skin = ModAPI.LoadTexture("my/pupsik.png");
                        var flesh = ModAPI.LoadTexture("flesh.png");
